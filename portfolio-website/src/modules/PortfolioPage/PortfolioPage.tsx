    ...
    return (
        <div className="flex flex-col items-center gap-12 justify-evenly py-8 px-12 bg-cover min-h-[100vh] bg-center bg-[url('../../public/images/horse_head_nebula.jpg')]">
            ...
            <div className="flex flex-col gap-12 items-center justify-evenly">
                {/* <h1>Portfolio</h1> */}
                <p className="w-[80vw] text-center text-lg">Here's an overview of my personal projects, as well as the team projects I worked on as a student of <a href="https://io-academy.uk" target="_blank" className="text-rose-300">the iO Academy bootcamp.</a></p>
            ...
            <footer className="mt-12 text-sm">
                <p>© Melody Sylvestre 2024 -  Image on the About page by <a className="text-rose-300"
